...
# this script is (3) validation data +0.5 (always)
...
# =================================================================================================
# This is scenario 3: use a Jeffreys prior beta (α = 0.5, β = 0.5) 
set.seed(789)
...
write.xlsx(final[[1]], file = paste0("S3_result100k_", Sys.Date(), ".xlsx"))
write.xlsx(final[[2]], file = paste0("S3_Data100k_", Sys.Date(), ".xlsx"))
# population size 10k
final2 <- SimVFunc(E = 0.2, R = 0.01, RR = 2, Se = 0.6,  Sp = 0.98, n = 10000, num.rep = 100000, num.subiter =10000)
write.xlsx(final2[[1]], file = paste0("S3_result10k_", Sys.Date(), ".xlsx"))
write.xlsx(final2[[2]], file = paste0("S3_Data10k_", Sys.Date(), ".xlsx"))
