...
# this script is (2) validation data +1 (always)
...
# =================================================================================================
# This is scenario 2: use a uniform prior beta (α = 1, β = 1) 
set.seed(789)
...
SimVFunc <- function(E, R, RR, Se, Sp, n, num.rep, num.subiter){
  ...
  #Se = 0.6 # exposure classification prior: sensitivity 60%
  #Sp = 0.90 # exposure classification prior: specificity 98%, changed to 90%
...
write.xlsx(final[[1]], file = paste0("S2_result100k_", Sys.Date(), ".xlsx"))
write.xlsx(final[[2]], file = paste0("S2_Data100k_", Sys.Date(), ".xlsx"))
# population size 10k
final2 <- SimVFunc(E = 0.2, R = 0.01, RR = 2, Se = 0.6,  Sp = 0.98, n = 10000, num.rep = 100000, num.subiter =10000)
write.xlsx(final2[[1]], file = paste0("S2_result10k_", Sys.Date(), ".xlsx"))
write.xlsx(final2[[2]], file = paste0("S2_Data10k_", Sys.Date(), ".xlsx"))
